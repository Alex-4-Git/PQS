...
import im.castor.ConnectFour.Model.Board.Coordinate;
...
public class BoardTest {
	...
	/**
	 * Test whether returns a new board or returns the same board.
	 */
	@Test
	...
	/**
	 * Test the getColumnState method.
	 */
	@Test
	...
	public void undoMoveSuccessTest() {
		...
		int actual = board.getBoardDataArray()[0][0];
		int expected = 2;
		assertEquals(expected, actual);

		board.undoMove();
		actual = board.getBoardDataArray()[0][0];
		expected = 0;
		assertEquals(expected, actual);
	}
	...
	public void getBoardDataArrayTest() {
		...
		board.move(2);
		int expected = 2;
		int actual = board.getBoardDataArray()[4][2];
		assertEquals(expected, actual);
	}
	...
	/**
	 * Test for the over situation with 4 vertical chess.
	 */
	@Test
	...
	/**
	 * Test for the over situation with 4 horizontal chess.
	 */
	@Test
	...
	/**
	 * Test for the over situation with 4 chess in diagonal.
	 */
	@Test
	...
	/**
	 * Test for the over situation with 4 chess in anti-diagonal.
	 */
	@Test
	...
	public void getWinStepTest() {
		...
		List<Coordinate> winStep = board.getWinStep();
